        ...
        try {
            ...
            const res = await fetch(`https://jiotvapi.media.jio.com/userservice/apis/v1/loginotp/send`, {
                ...
                headers: {
                    ...
                    'os': 'android',
                    'devicetype': 'phone',
                    'User-Agent': 'JioTV/2.4.0 (Linux; U; Android 9; SM-G975F Build/PPR1.180610.011)',
                    'x-device-id': 'b8e976b5-0000-4000-8000-0123456789ab'
                },
                body: JSON.stringify({
                    number: finalNumber,
                    otpType: 'sms'
            ...
            try {
                ...
                return { error: `Invalid server response: ${text.substring(0, 100)}`, status: res.status };
            }
        } catch (e) {
        ...
        try {
            ...
            const res = await fetch(`https://jiotvapi.media.jio.com/userservice/apis/v1/loginotp/verify`, {
                ...
                body: JSON.stringify({
                    ...
                    otp: otp,
                    deviceInfo: {
                        consumptionDeviceName: 'Samsung SM-G975F',
                        info: {
                            type: 'android',
                            platform: {
                                name: 'goldfish',
            ...
            try {
                ...
                return { error: `Invalid verification response: ${text.substring(0, 100)}` };
            }
        } catch (e) {
            return { error: e.message };
        }
