                ...
                if (key === 'inputstream.adaptive.license_type') {
                        ...
                        try {
                            ...
                            if (jwk.keys && jwk.keys.length > 0) {
                                ...
                                if (keyObj.k && keyObj.kid) {
                                    currentItem.drmKey = Buffer.from(keyObj.k.replace(/-/g, '+').replace(/_/g, '/'), 'base64').toString('hex');
                                    currentItem.drmKeyId = Buffer.from(keyObj.kid.replace(/-/g, '+').replace(/_/g, '/'), 'base64').toString('hex');
                                    currentItem.drmScheme = 'clearkey';
                                }
                            }
                        } catch (e) { }
                    ...
                    try {
                        ...
                        if (urlStr && urlStr.startsWith('http')) {
                            ...
                            if (keyid && keyValue) currentItem.drmScheme = 'clearkey';
                        }
                    } catch (e) { }
