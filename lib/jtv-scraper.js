...
const DEFAULT_URL = 'https://raw.githubusercontent.com/souravslg/iptvpanel/main/jtv.m3u';

export async function fetchJTVPlaylist(customUrl = null) {
    const targetUrl = customUrl || DEFAULT_URL;
    try {
        console.log(`Fetching JTV playlist from ${targetUrl}...`);
